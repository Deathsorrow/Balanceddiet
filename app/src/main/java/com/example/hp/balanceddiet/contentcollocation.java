...
public class contentcollocation extends ListActivity implements OnItemClickListener {

    private String TAG = "contentcollocation";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setContentView(R.layout.content_collocation);
        ...
        //for (int i = 0; i < resId.length; i++) {
           ...
           // map.put("photo", resId[i]);
           // map.put("itemTitle", food[i]);
            //map.put("itemDetail", food1[i]);
            //lists.add(map);
        //}
        ...
        //SimpleAdapter adapter = new SimpleAdapter(this, lists,
                //R.layout.collocation_list, new String[] { "photo",
                //"itemTitle", "itemDetail" }, new int[] {
               // R.id.photo, R.id.itemTitle, R.id.itemDetail });
        //setListAdapter(adapter);
